...
class CustomException extends Exception
{
  ...
  public static function sendPasswordResetLink(): static
  {
    return new static('We have emailed your password reset link!', 200);
  }

  public static function resetPassword(): static
  {
    return new static('Your password has been reset successfully!', 200);
  }
  ...
  public static function is_active(): static
  {
    return new static("You need to wait admin approve!", 403);
  }
